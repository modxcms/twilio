...
class FixedBitNotation
{
    ...
    protected int $bitsPerCharacter;
    protected int $radix;
    protected bool $rightPadFinalBits;
    protected bool $padFinalGroup;
